...
class AllDishesActivity : AppCompatActivity() {
    ...
    private fun getAllDishes(): List<Recipe> {
        ...
        return listOf(
            ...
            Recipe("Bún thang", "10 Min", "200 Kcal", R.drawable.dish_image_7),
            Recipe("Bún riêu cua", "10 Min", "200 Kcal", R.drawable.dish_image_8),
            Recipe("Mỳ bò Đài Loan", "10 Min", "200 Kcal", R.drawable.dish_image_9),
